...
def index(request):
    context_dict = {
        'text':'hello world',
        'number':'120',
        'questions':Choice.objects.order_by("votes"),
        }
...
def questions (request):
    ...
    form = forms.New_QuestionForm()

    if request.method == "POST":
        form = forms.New_Question(request.POST)
    ...
    return render(request,'basic_app/Questions.html',{'form':form})
